...
export class ComponentCharacteristicsDisplayType {
  /**
   * Constructs a new <code>ComponentCharacteristicsDisplayType</code>.
   * A list of supported display types and the physical screen diagonal.
   * @alias module:model/ComponentCharacteristicsDisplayType
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ComponentCharacteristicsDisplayType();
      if (data.hasOwnProperty('screenDiagonal'))
        obj.screenDiagonal = ApiClient.convertToType(data['screenDiagonal'], 'Number');
      if (data.hasOwnProperty('resolutions'))
        obj.resolutions = ApiClient.convertToType(data['resolutions'], [ScreenResolution]);
    }
    return obj;
  }
}
 ...
 */
ComponentCharacteristicsDisplayType.prototype.screenDiagonal = undefined;

/**
 * @member {Array.<module:model/ScreenResolution>} resolutions
 */
ComponentCharacteristicsDisplayType.prototype.resolutions = undefined;
