...
/**
 * Enum class OperationDocumentType.
 * @enum {String}
 * @readonly
 */
const OperationDocumentType = {
  /**
   * value: "NONE"
   * @const
   */
  ...
  /**
   * Returns a <code>OperationDocumentType</code> enum value from a JavaScript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
  * @return {module:model/OperationDocumentType} The enum <code>OperationDocumentType</code> value.
   */
