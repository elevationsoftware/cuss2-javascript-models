...
export class BiometricProviderMessageBiometricRequestAgreementsList {
   ...
   */
  constructor(agreementTextList) {
    this.agreementTextList = agreementTextList;
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new BiometricProviderMessageBiometricRequestAgreementsList();
      if (data.hasOwnProperty('agreementTextList'))
        obj.agreementTextList = ApiClient.convertToType(data['agreementTextList'], [AgreementTextType]);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:model/AgreementTextType>} agreementTextList
 */
BiometricProviderMessageBiometricRequestAgreementsList.prototype.agreementTextList = undefined;
