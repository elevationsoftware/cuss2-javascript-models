...
import {RgbType} from './RgbType.js';
...
export class IlluminationDataLightColor {
  /**
   * Constructs a new <code>IlluminationDataLightColor</code>.
   ...
   * @alias module:model/IlluminationDataLightColor
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new IlluminationDataLightColor();
      if (data.hasOwnProperty('name'))
        obj.name = ApiClient.convertToType(data['name'], 'String');
      if (data.hasOwnProperty('rgb'))
        obj.rgb = RgbType.constructFromObject(data['rgb']);
    }
    return obj;
  }
}
 ...
 * @readonly
 */
IlluminationDataLightColor.NameEnum = {
  /**
   * value: "CLR_ON"
   * @const
   */
 ...
 */
IlluminationDataLightColor.prototype.name = undefined;

/**
 * @member {module:model/RgbType} rgb
 */
IlluminationDataLightColor.prototype.rgb = undefined;
