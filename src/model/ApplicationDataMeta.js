...
export class ApplicationDataMeta {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ApplicationDataMeta();
 ...
 */
ApplicationDataMeta.prototype.requestID = undefined;

/**
 * Application token (JWT) received with the Client Credentials. The token shall be passed with every platfrom directive. 
 * @member {String} oauthToken
 */
ApplicationDataMeta.prototype.oauthToken = undefined;

/**
 * @member {module:model/PlatformDirectives} directive
 */
ApplicationDataMeta.prototype.directive = undefined;
