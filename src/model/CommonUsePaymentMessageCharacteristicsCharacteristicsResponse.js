...
import {CommonUsePaymentMessageCharacteristicsCharacteristicsResponseEPayment} from './CommonUsePaymentMessageCharacteristicsCharacteristicsResponseEPayment.js';
...
export class CommonUsePaymentMessageCharacteristicsCharacteristicsResponse {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CommonUsePaymentMessageCharacteristicsCharacteristicsResponse();
      if (data.hasOwnProperty('dsTypes'))
        obj.dsTypes = DsTypesEpayment.constructFromObject(data['dsTypes']);
      if (data.hasOwnProperty('ePayment'))
        obj.ePayment = CommonUsePaymentMessageCharacteristicsCharacteristicsResponseEPayment.constructFromObject(data['ePayment']);
    }
    return obj;
  }
}
 ...
 */
CommonUsePaymentMessageCharacteristicsCharacteristicsResponse.prototype.dsTypes = undefined;

/**
 * @member {module:model/CommonUsePaymentMessageCharacteristicsCharacteristicsResponseEPayment} ePayment
 */
CommonUsePaymentMessageCharacteristicsCharacteristicsResponse.prototype.ePayment = undefined;
