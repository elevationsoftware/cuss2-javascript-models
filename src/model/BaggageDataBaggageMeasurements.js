...
export class BaggageDataBaggageMeasurements {
  /**
   * Constructs a new <code>BaggageDataBaggageMeasurements</code>.
   * Values identified for an object on the measurement device.
   * @alias module:model/BaggageDataBaggageMeasurements
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new BaggageDataBaggageMeasurements();
      if (data.hasOwnProperty('weight'))
        obj.weight = WeightType.constructFromObject(data['weight']);
      if (data.hasOwnProperty('dimensions'))
        obj.dimensions = DimensionType.constructFromObject(data['dimensions']);
    }
    return obj;
  }
}
 ...
 */
BaggageDataBaggageMeasurements.prototype.weight = undefined;

/**
 * @member {module:model/DimensionType} dimensions
 */
BaggageDataBaggageMeasurements.prototype.dimensions = undefined;
