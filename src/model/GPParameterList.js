...
export class GPParameterList {
  /**
   * Constructs a new <code>GPParameterList</code>.
   * General-purpose parameters.
   * @alias module:model/GPParameterList
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new GPParameterList();
      if (data.hasOwnProperty('gpParameters'))
        obj.gpParameters = ApiClient.convertToType(data['gpParameters'], [GPParameter]);
    }
    return obj;
  }
}
 ...
 */
GPParameterList.prototype.gpParameters = undefined;
