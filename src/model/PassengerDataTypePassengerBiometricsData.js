...
export class PassengerDataTypePassengerBiometricsData {
   ...
   */
  constructor(passengerBiometrics) {
    this.passengerBiometrics = passengerBiometrics;
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new PassengerDataTypePassengerBiometricsData();
      if (data.hasOwnProperty('passengerBiometrics'))
        obj.passengerBiometrics = ApiClient.convertToType(data['passengerBiometrics'], [PassengerBiometricsType]);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:model/PassengerBiometricsType>} passengerBiometrics
 */
PassengerDataTypePassengerBiometricsData.prototype.passengerBiometrics = undefined;
