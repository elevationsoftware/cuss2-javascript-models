...
export class ComponentCharacteristicsDocumentBin {
  /**
   * Constructs a new <code>ComponentCharacteristicsDocumentBin</code>.
   * Document bin characteristics for Feeder-, Dispenser-, Capture- components.
   * @alias module:model/ComponentCharacteristicsDocumentBin
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ComponentCharacteristicsDocumentBin();
      if (data.hasOwnProperty('binSize'))
        obj.binSize = ApiClient.convertToType(data['binSize'], 'Number');
      if (data.hasOwnProperty('allmostFullLevel'))
        obj.allmostFullLevel = ApiClient.convertToType(data['allmostFullLevel'], 'Number');
      if (data.hasOwnProperty('allmostEmptyLevel'))
        obj.allmostEmptyLevel = ApiClient.convertToType(data['allmostEmptyLevel'], 'Number');
    }
    return obj;
  }
}
 ...
 */
ComponentCharacteristicsDocumentBin.prototype.binSize = undefined;

/**
 * Shows the high threshold of the bin if appropriate sensor is installed.
 * @member {Number} allmostFullLevel
 */
ComponentCharacteristicsDocumentBin.prototype.allmostFullLevel = undefined;

/**
 * Shows the low threshold of the bin if appropriate sensor is installed.
 * @member {Number} allmostEmptyLevel
 */
ComponentCharacteristicsDocumentBin.prototype.allmostEmptyLevel = undefined;
