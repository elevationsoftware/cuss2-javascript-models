...
import {BiometricProviderMessageBiometricRequest} from './BiometricProviderMessageBiometricRequest.js';
import {BiometricProviderMessageBiometricRequestData} from './BiometricProviderMessageBiometricRequestData.js';
import {BiometricProviderMessageBiometricResponse} from './BiometricProviderMessageBiometricResponse.js';
import {BiometricProviderMessageType} from './BiometricProviderMessageType.js';
...
export class BiometricProviderMessage {
   ...
   */
  constructor(biometricProviderMessageType, biometricProviderMessageReturnType, biometricFunctionType) {
    this.biometricProviderMessageType = biometricProviderMessageType;
    this.biometricProviderMessageReturnType = biometricProviderMessageReturnType;
    this.biometricFunctionType = biometricFunctionType;
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new BiometricProviderMessage();
      if (data.hasOwnProperty('biometricProviderMessageType'))
        obj.biometricProviderMessageType = BiometricProviderMessageType.constructFromObject(data['biometricProviderMessageType']);
      if (data.hasOwnProperty('biometricProviderMessageReturnType'))
        obj.biometricProviderMessageReturnType = BiometricProviderMessageType.constructFromObject(data['biometricProviderMessageReturnType']);
      if (data.hasOwnProperty('biometricFunctionType'))
        obj.biometricFunctionType = ApiClient.convertToType(data['biometricFunctionType'], 'String');
      if (data.hasOwnProperty('biometricRequest'))
        obj.biometricRequest = BiometricProviderMessageBiometricRequest.constructFromObject(data['biometricRequest']);
      if (data.hasOwnProperty('biometricRequestData'))
        obj.biometricRequestData = BiometricProviderMessageBiometricRequestData.constructFromObject(data['biometricRequestData']);
      if (data.hasOwnProperty('biometricResponse'))
        obj.biometricResponse = BiometricProviderMessageBiometricResponse.constructFromObject(data['biometricResponse']);
    }
    return obj;
  }
}
...
/**
 * @member {module:model/BiometricProviderMessageType} biometricProviderMessageType
 */
BiometricProviderMessage.prototype.biometricProviderMessageType = undefined;

/**
 * @member {module:model/BiometricProviderMessageType} biometricProviderMessageReturnType
 */
BiometricProviderMessage.prototype.biometricProviderMessageReturnType = undefined;

/**
 * Allowed values for the <code>biometricFunctionType</code> property.
 * @enum {String}
 * @readonly
 */
 ...
 * @member {module:model/BiometricProviderMessage.BiometricFunctionTypeEnum} biometricFunctionType
 */
BiometricProviderMessage.prototype.biometricFunctionType = undefined;

/**
 * @member {module:model/BiometricProviderMessageBiometricRequest} biometricRequest
 */
BiometricProviderMessage.prototype.biometricRequest = undefined;

/**
 * @member {module:model/BiometricProviderMessageBiometricRequestData} biometricRequestData
 */
BiometricProviderMessage.prototype.biometricRequestData = undefined;

/**
 * @member {module:model/BiometricProviderMessageBiometricResponse} biometricResponse
 */
BiometricProviderMessage.prototype.biometricResponse = undefined;
