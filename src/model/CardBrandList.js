...
export class CardBrandList {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CardBrandList();
      if (data.hasOwnProperty('overridable'))
        obj.overridable = ApiClient.convertToType(data['overridable'], 'Boolean');
      if (data.hasOwnProperty('cardBrands'))
        obj.cardBrands = ApiClient.convertToType(data['cardBrands'], [CardBrand]);
    }
    return obj;
  }
}
 ...
 */
CardBrandList.prototype.overridable = undefined;

/**
 * @member {Array.<module:model/CardBrand>} cardBrands
 */
CardBrandList.prototype.cardBrands = undefined;
