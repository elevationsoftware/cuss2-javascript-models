...
export class BiometricProviderMessageBiometricResponse {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new BiometricProviderMessageBiometricResponse();
      ...
      if (data.hasOwnProperty('failureReason'))
        obj.failureReason = BiometricProviderMessageBiometricResponseFailureReason.constructFromObject(data['failureReason']);
      if (data.hasOwnProperty('passengerData'))
        obj.passengerData = PassengerDataType.constructFromObject(data['passengerData']);
 ...
 * @readonly
 */
BiometricProviderMessageBiometricResponse.ResponseTypeEnum = {
  /**
   * value: "CANCELLATION"
   * @const
   */
...
/**
 * @member {module:model/BiometricProviderMessageBiometricResponse.ResponseTypeEnum} responseType
 */
BiometricProviderMessageBiometricResponse.prototype.responseType = undefined;

/**
 * @member {module:model/BiometricProviderMessageBiometricResponseFailureReason} failureReason
 */
BiometricProviderMessageBiometricResponse.prototype.failureReason = undefined;

/**
 * @member {module:model/PassengerDataType} passengerData
 */
BiometricProviderMessageBiometricResponse.prototype.passengerData = undefined;

/**
 * @member {module:model/GPDataListType} gpDataList
 */
BiometricProviderMessageBiometricResponse.prototype.gpDataList = undefined;
