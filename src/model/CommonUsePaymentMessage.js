...
export class CommonUsePaymentMessage {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CommonUsePaymentMessage();
      ...
      if (data.hasOwnProperty('characteristics'))
        obj.characteristics = CommonUsePaymentMessageCharacteristics.constructFromObject(data['characteristics']);
      if (data.hasOwnProperty('ePaymentMessage'))
        obj.ePaymentMessage = EPaymentMessage.constructFromObject(data['ePaymentMessage']);
      if (data.hasOwnProperty('errorResponse'))
        obj.errorResponse = CommonUsePaymentMessageErrorResponse.constructFromObject(data['errorResponse']);
    }
    return obj;
  }
}
 ...
 */
CommonUsePaymentMessage.prototype.sessionID = undefined;
 ...
 * @readonly
 */
CommonUsePaymentMessage.DocumentTypeEnum = {
  /**
  ...
  /**
   * value: "EPAYMENT_MESSAGE"
   * @const
   */
  EPAYMENT_MESSAGE: "EPAYMENT_MESSAGE",
 ...
 * @member {module:model/CommonUsePaymentMessage.DocumentTypeEnum} documentType
 */
CommonUsePaymentMessage.prototype.documentType = undefined;

/**
 * @member {module:model/CommonUsePaymentMessageCharacteristics} characteristics
 */
CommonUsePaymentMessage.prototype.characteristics = undefined;

/**
 * @member {module:model/EPaymentMessage} ePaymentMessage
 */
CommonUsePaymentMessage.prototype.ePaymentMessage = undefined;

/**
 * @member {module:model/CommonUsePaymentMessageErrorResponse} errorResponse
 */
CommonUsePaymentMessage.prototype.errorResponse = undefined;
