  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('currencyCodes'))
        obj.currencyCodes = ApiClient.convertToType(data['currencyCodes'], [CurrencyCode]);
    }
    return obj;
  }
}
 ...
 */
CurrencyCodeList.prototype.overridable = undefined;

/**
 * @member {Array.<module:model/CurrencyCode>} currencyCodes
 */
CurrencyCodeList.prototype.currencyCodes = undefined;
