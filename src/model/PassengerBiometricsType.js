...
export class PassengerBiometricsType {
   ...
   */
  constructor(biometricsType, dataFormat) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new PassengerBiometricsType();
      if (data.hasOwnProperty('data'))
        obj.data = ApiClient.convertToType(data['data'], 'Blob');
      if (data.hasOwnProperty('biometricsType'))
        obj.biometricsType = ApiClient.convertToType(data['biometricsType'], 'String');
 ...
 * @member {Blob} data
 */
PassengerBiometricsType.prototype.data = undefined;

/**
 * Allowed values for the <code>biometricsType</code> property.
 * @enum {String}
 * @readonly
 */
...
/**
 * @member {module:model/PassengerBiometricsType.BiometricsTypeEnum} biometricsType
 */
PassengerBiometricsType.prototype.biometricsType = undefined;

/**
 * Allowed values for the <code>lightType</code> property.
 * @enum {String}
 * @readonly
 */
 ...
 */
PassengerBiometricsType.prototype.lightType = undefined;
 ...
 */
PassengerBiometricsType.prototype.dataSource = undefined;
...
/**
 * @member {module:model/PassengerBiometricsType.DataFormatEnum} dataFormat
 */
PassengerBiometricsType.prototype.dataFormat = undefined;
