...
export class AssociationDataItemType {
   ...
   */
  constructor(associationDataTag) {
    this.associationDataTag = associationDataTag;
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AssociationDataItemType();
      if (data.hasOwnProperty('data'))
        obj.data = ApiClient.convertToType(data['data'], 'Blob');
      if (data.hasOwnProperty('associationDataTag'))
        obj.associationDataTag = ApiClient.convertToType(data['associationDataTag'], 'String');
    }
    return obj;
  }
}
 ...
 * @member {Blob} data
 */
AssociationDataItemType.prototype.data = undefined;

/**
 * @member {String} associationDataTag
 */
AssociationDataItemType.prototype.associationDataTag = undefined;
