...
export class CommonUsePaymentMessageCharacteristicsCharacteristicsResponseEPayment {
  /**
   * Constructs a new <code>CommonUsePaymentMessageCharacteristicsCharacteristicsResponseEPayment</code>.
   * ePayment component characteristics.
   * @alias module:model/CommonUsePaymentMessageCharacteristicsCharacteristicsResponseEPayment
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CommonUsePaymentMessageCharacteristicsCharacteristicsResponseEPayment();
      if (data.hasOwnProperty('featureList'))
        obj.featureList = FeatureList.constructFromObject(data['featureList']);
      if (data.hasOwnProperty('cardBrandList'))
        obj.cardBrandList = CardBrandList.constructFromObject(data['cardBrandList']);
      if (data.hasOwnProperty('mediaTypeList'))
        obj.mediaTypeList = MediaTypeList.constructFromObject(data['mediaTypeList']);
      if (data.hasOwnProperty('currencyCodeList'))
        obj.currencyCodeList = CurrencyCodeList.constructFromObject(data['currencyCodeList']);
    }
    return obj;
  }
}
 ...
 */
CommonUsePaymentMessageCharacteristicsCharacteristicsResponseEPayment.prototype.featureList = undefined;

/**
 * @member {module:model/CardBrandList} cardBrandList
 */
CommonUsePaymentMessageCharacteristicsCharacteristicsResponseEPayment.prototype.cardBrandList = undefined;

/**
 * @member {module:model/MediaTypeList} mediaTypeList
 */
CommonUsePaymentMessageCharacteristicsCharacteristicsResponseEPayment.prototype.mediaTypeList = undefined;

/**
 * @member {module:model/CurrencyCodeList} currencyCodeList
 */
CommonUsePaymentMessageCharacteristicsCharacteristicsResponseEPayment.prototype.currencyCodeList = undefined;
