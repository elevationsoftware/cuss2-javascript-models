...
export class CommonUseBiometricMessageCharacteristicsCharacteristicsResponse {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CommonUseBiometricMessageCharacteristicsCharacteristicsResponse();
      if (data.hasOwnProperty('dsTypes'))
        obj.dsTypes = ApiClient.convertToType(data['dsTypes'], Object);
    }
    return obj;
  }
}
...
/**
 * DS type(s) string.
 * @member {Object} dsTypes
 */
CommonUseBiometricMessageCharacteristicsCharacteristicsResponse.prototype.dsTypes = undefined;
