...
export class DataRecord {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DataRecord();
      if (data.hasOwnProperty('dataStatus'))
        obj.dataStatus = DataStatus.constructFromObject(data['dataStatus']);
      if (data.hasOwnProperty('dsTypes'))
        obj.dsTypes = ApiClient.convertToType(data['dsTypes'], [CUSSDataTypes]);
 ...
 */
DataRecord.prototype.dataStatus = undefined;

/**
 * The type(s) of data in this data record.
 * @member {Array.<module:model/CUSSDataTypes>} dsTypes
 */
DataRecord.prototype.dsTypes = undefined;

/**
 * The data itself in base64 coding, which also can be NULL, null, NIL, nil,...
 * @member {Blob} data
 */
DataRecord.prototype.data = undefined;
