...
export class EPaymentMessageTransactionTransactionRequest {
  /**
   * Constructs a new <code>EPaymentMessageTransactionTransactionRequest</code>.
   * Financial request from common use application to payment component.
   * @alias module:model/EPaymentMessageTransactionTransactionRequest
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new EPaymentMessageTransactionTransactionRequest();
      if (data.hasOwnProperty('language'))
        obj.language = ApiClient.convertToType(data['language'], 'String');
      if (data.hasOwnProperty('environment'))
        obj.environment = EPaymentMessageTransactionTransactionRequestEnvironment.constructFromObject(data['environment']);
      if (data.hasOwnProperty('preAuth'))
        obj.preAuth = EPaymentMessageTransactionTransactionRequestPreAuth.constructFromObject(data['preAuth']);
      if (data.hasOwnProperty('account'))
        obj.account = EPaymentMessageTransactionTransactionRequestAccount.constructFromObject(data['account']);
      if (data.hasOwnProperty('itinerary'))
        obj.itinerary = EPaymentMessageTransactionTransactionRequestItinerary.constructFromObject(data['itinerary']);
      if (data.hasOwnProperty('billingDescription'))
        obj.billingDescription = ApiClient.convertToType(data['billingDescription'], 'String');
 ...
 */
EPaymentMessageTransactionTransactionRequest.prototype.language = undefined;

/**
 * @member {module:model/EPaymentMessageTransactionTransactionRequestEnvironment} environment
 */
EPaymentMessageTransactionTransactionRequest.prototype.environment = undefined;

/**
 * @member {module:model/EPaymentMessageTransactionTransactionRequestPreAuth} preAuth
 */
EPaymentMessageTransactionTransactionRequest.prototype.preAuth = undefined;

/**
 * @member {module:model/EPaymentMessageTransactionTransactionRequestAccount} account
 */
EPaymentMessageTransactionTransactionRequest.prototype.account = undefined;

/**
 * @member {module:model/EPaymentMessageTransactionTransactionRequestItinerary} itinerary
 */
EPaymentMessageTransactionTransactionRequest.prototype.itinerary = undefined;
 ...
 */
EPaymentMessageTransactionTransactionRequest.prototype.billingDescription = undefined;

/**
 * @member {module:model/GPParameterList} gpParameters
 */
EPaymentMessageTransactionTransactionRequest.prototype.gpParameters = undefined;

/**
 * @member {module:model/AuthorizationAmounts} authorizationAmounts
 */
EPaymentMessageTransactionTransactionRequest.prototype.authorizationAmounts = undefined;
