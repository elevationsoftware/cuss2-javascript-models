...
export class PlatformData {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new PlatformData();
      if (data.hasOwnProperty('meta'))
        obj.meta = PlatformDataMeta.constructFromObject(data['meta']);
      if (data.hasOwnProperty('payload'))
        obj.payload = PlatformDataPayload.constructFromObject(data['payload']);
    }
    return obj;
  }
}
...
/**
 * @member {module:model/PlatformDataMeta} meta
 */
PlatformData.prototype.meta = undefined;

/**
 * @member {module:model/PlatformDataPayload} payload
 */
PlatformData.prototype.payload = undefined;
