...
export class CardTrackType {
  /**
   * Constructs a new <code>CardTrackType</code>.
   * The card track and its corresponding index
   * @alias module:model/CardTrackType
   * @class
   */
  constructor() {
  }
 ...
 */
CardTrackType.prototype.trackNumber = undefined;

/**
 * @member {String} trackData
 */
CardTrackType.prototype.trackData = undefined;
