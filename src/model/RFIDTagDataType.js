...
export class RFIDTagDataType {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RFIDTagDataType();
      if (data.hasOwnProperty('id'))
        obj.id = ApiClient.convertToType(data['id'], 'String');
      if (data.hasOwnProperty('rfidElements'))
        obj.rfidElements = ApiClient.convertToType(data['rfidElements'], [RFIDElement]);
    }
    return obj;
  }
}
 ...
 * @member {String} id
 */
RFIDTagDataType.prototype.id = undefined;

/**
 * @member {Array.<module:model/RFIDElement>} rfidElements
 */
RFIDTagDataType.prototype.rfidElements = undefined;
