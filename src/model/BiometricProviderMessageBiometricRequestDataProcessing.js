...
export class BiometricProviderMessageBiometricRequestDataProcessing {
  /**
   * Constructs a new <code>BiometricProviderMessageBiometricRequestDataProcessing</code>.
   * @alias module:model/BiometricProviderMessageBiometricRequestDataProcessing
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new BiometricProviderMessageBiometricRequestDataProcessing();
      if (data.hasOwnProperty('keypadKey'))
        obj.keypadKey = ApiClient.convertToType(data['keypadKey'], ['String']);
    }
    return obj;
  }
}
 ...
 */
BiometricProviderMessageBiometricRequestDataProcessing.prototype.keypadKey = undefined;
