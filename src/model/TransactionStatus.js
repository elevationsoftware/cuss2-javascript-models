...
export class TransactionStatus {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('transactionStatusID'))
        obj.transactionStatusID = ApiClient.convertToType(data['transactionStatusID'], 'String');
    }
    return obj;
  }
}
...
/**
 * Allowed values for the <code>transactionStatusID</code> property.
 * @enum {String}
 * @readonly
 */
TransactionStatus.TransactionStatusIDEnum = {
  ...
  /**
   * value: "APPLICATION_SELECTION"
   * @const
   */
  APPLICATION_SELECTION: "APPLICATION_SELECTION",

  /**
   * value: "CARD_INSERTION"
   * @const
   */
  ...
  /**
   * value: "CASHBACK_ENTRY"
   * @const
   */
  CASHBACK_ENTRY: "CASHBACK_ENTRY",
 ...
 */
TransactionStatus.prototype.transactionStatusID = undefined;
