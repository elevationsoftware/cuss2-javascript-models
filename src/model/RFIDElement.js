  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('stringData'))
        obj.stringData = ApiClient.convertToType(data['stringData'], 'String');
    }
    return obj;
  }
}
 ...
 */
RFIDElement.prototype.objectKey = undefined;

/**
 * RFID tag data in binary format
 * @member {Blob} binaryData
 */
RFIDElement.prototype.binaryData = undefined;

/**
 * RFID tag data as a normal string
 * @member {String} stringData
 */
RFIDElement.prototype.stringData = undefined;
