...
export class MRZTrackType {
  /**
   * Constructs a new <code>MRZTrackType</code>.
   * The MRZ track and its corresponding index
   * @alias module:model/MRZTrackType
   * @class
   */
  constructor() {
  }
 ...
 */
MRZTrackType.prototype.trackData = undefined;

/**
 * @member {Number} trackNumber
 */
MRZTrackType.prototype.trackNumber = undefined;
