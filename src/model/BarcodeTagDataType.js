...
export class BarcodeTagDataType {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new BarcodeTagDataType();
      if (data.hasOwnProperty('lpnNumber'))
        obj.lpnNumber = ApiClient.convertToType(data['lpnNumber'], 'String');
    }
    return obj;
  }
}
...
/**
 * @member {String} lpnNumber
 */
BarcodeTagDataType.prototype.lpnNumber = undefined;
