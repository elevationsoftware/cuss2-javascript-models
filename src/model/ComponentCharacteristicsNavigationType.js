...
export class ComponentCharacteristicsNavigationType {
  /**
   * Constructs a new <code>ComponentCharacteristicsNavigationType</code>.
   * @alias module:model/ComponentCharacteristicsNavigationType
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ComponentCharacteristicsNavigationType();
      if (data.hasOwnProperty('type'))
        obj.type = NavigationTypes.constructFromObject(data['type']);
    }
    return obj;
  }
}
 ...
 */
ComponentCharacteristicsNavigationType.prototype.type = undefined;
