...
export class PlatformDataMetaEventClassification {
  /**
   * Constructs a new <code>PlatformDataMetaEventClassification</code>.
   * More detailed description of the event/indication that is sent by the platform. 
   * @alias module:model/PlatformDataMetaEventClassification
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new PlatformDataMetaEventClassification();
      if (data.hasOwnProperty('eventMode'))
        obj.eventMode = EventModes.constructFromObject(data['eventMode']);
      if (data.hasOwnProperty('eventType'))
        obj.eventType = EventTypes.constructFromObject(data['eventType']);
      if (data.hasOwnProperty('eventCategory'))
        obj.eventCategory = EventCategories.constructFromObject(data['eventCategory']);
    }
    return obj;
  }
}
 ...
 */
PlatformDataMetaEventClassification.prototype.eventMode = undefined;

/**
 * @member {module:model/EventTypes} eventType
 */
PlatformDataMetaEventClassification.prototype.eventType = undefined;

/**
 * @member {module:model/EventCategories} eventCategory
 */
PlatformDataMetaEventClassification.prototype.eventCategory = undefined;
