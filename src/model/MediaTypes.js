...
const MediaTypes = {
  ...
  /**
   * Returns a <code>MediaTypes</code> enum value from a JavaScript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
  * @return {module:model/MediaTypes} The enum <code>MediaTypes</code> value.
   */
