  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('mediaTypes'))
        obj.mediaTypes = ApiClient.convertToType(data['mediaTypes'], [MediaType]);
    }
    return obj;
  }
}
 ...
 */
MediaTypeList.prototype.overridable = undefined;

/**
 * @member {Array.<module:model/MediaType>} mediaTypes
 */
MediaTypeList.prototype.mediaTypes = undefined;
