...
export class BaggageDataRfidTagList {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new BaggageDataRfidTagList();
      if (data.hasOwnProperty('rfidTag'))
        obj.rfidTag = ApiClient.convertToType(data['rfidTag'], [RFIDTagDataType]);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:model/RFIDTagDataType>} rfidTag
 */
BaggageDataRfidTagList.prototype.rfidTag = undefined;
