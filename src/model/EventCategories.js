...
const EventCategories = {
  ...
  /**
   * Returns a <code>EventCategories</code> enum value from a JavaScript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
  * @return {module:model/EventCategories} The enum <code>EventCategories</code> value.
   */
