...
export class BaggageDataBarcodeTagList {
  /**
   * Constructs a new <code>BaggageDataBarcodeTagList</code>.
   * List of optical barcode measurement values
   * @alias module:model/BaggageDataBarcodeTagList
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new BaggageDataBarcodeTagList();
      if (data.hasOwnProperty('lpnBarcodeTag'))
        obj.lpnBarcodeTag = ApiClient.convertToType(data['lpnBarcodeTag'], [BarcodeTagDataType]);
      if (data.hasOwnProperty('otherBarcodeTag'))
        obj.otherBarcodeTag = ApiClient.convertToType(data['otherBarcodeTag'], ['String']);
    }
    return obj;
  }
}
 ...
 */
BaggageDataBarcodeTagList.prototype.lpnBarcodeTag = undefined;

/**
 * @member {Array.<String>} otherBarcodeTag
 */
BaggageDataBarcodeTagList.prototype.otherBarcodeTag = undefined;
