...
export class EPaymentMessageTransactionTransactionRequestAccountSwipe {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new EPaymentMessageTransactionTransactionRequestAccountSwipe();
      if (data.hasOwnProperty('track'))
        obj.track = ApiClient.convertToType(data['track'], [CardTrackType]);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:model/CardTrackType>} track
 */
EPaymentMessageTransactionTransactionRequestAccountSwipe.prototype.track = undefined;
