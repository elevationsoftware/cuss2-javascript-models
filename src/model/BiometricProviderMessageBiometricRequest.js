...
export class BiometricProviderMessageBiometricRequest {
  /**
   * Constructs a new <code>BiometricProviderMessageBiometricRequest</code>.
   * Biometric function request from common use application to biometric provider component.
   * @alias module:model/BiometricProviderMessageBiometricRequest
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new BiometricProviderMessageBiometricRequest();
      if (data.hasOwnProperty('environment'))
        obj.environment = BiometricProviderMessageBiometricRequestEnvironment.constructFromObject(data['environment']);
      if (data.hasOwnProperty('agreementsList'))
        obj.agreementsList = BiometricProviderMessageBiometricRequestAgreementsList.constructFromObject(data['agreementsList']);
      if (data.hasOwnProperty('passenger'))
        obj.passenger = PassengerDataType.constructFromObject(data['passenger']);
      if (data.hasOwnProperty('gpDataList'))
        obj.gpDataList = GPDataListType.constructFromObject(data['gpDataList']);
    }
    return obj;
  }
}
 ...
 */
BiometricProviderMessageBiometricRequest.prototype.environment = undefined;

/**
 * @member {module:model/BiometricProviderMessageBiometricRequestAgreementsList} agreementsList
 */
BiometricProviderMessageBiometricRequest.prototype.agreementsList = undefined;

/**
 * @member {module:model/PassengerDataType} passenger
 */
BiometricProviderMessageBiometricRequest.prototype.passenger = undefined;

/**
 * @member {module:model/GPDataListType} gpDataList
 */
BiometricProviderMessageBiometricRequest.prototype.gpDataList = undefined;
