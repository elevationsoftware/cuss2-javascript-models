...
export class ApplicationID {
  /**
   * Constructs a new <code>ApplicationID</code>.
   * @alias module:model/ApplicationID
   * @class
   */
  constructor() {
  }
 ...
 */
ApplicationID.prototype.companyCode = undefined;

/**
 * Name of the application
 * @member {String} applicationName
 */
ApplicationID.prototype.applicationName = undefined;
