...
import {DeviceHelpInstructionType} from './DeviceHelpInstructionType.js';
...
export class ComponentCharacteristicsDeviceHelpInstruction {
  /**
   * Constructs a new <code>ComponentCharacteristicsDeviceHelpInstruction</code>.
   * @alias module:model/ComponentCharacteristicsDeviceHelpInstruction
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ComponentCharacteristicsDeviceHelpInstruction();
      if (data.hasOwnProperty('instruction'))
        obj.instruction = DeviceHelpInstructionType.constructFromObject(data['instruction']);
      if (data.hasOwnProperty('ssmlVersion'))
        obj.ssmlVersion = ApiClient.convertToType(data['ssmlVersion'], 'String');
    }
    return obj;
  }
}
 ...
 */
ComponentCharacteristicsDeviceHelpInstruction.prototype.instruction = undefined;

/**
 * SSML version supported by the audio output component.
 * @member {String} ssmlVersion
 */
ComponentCharacteristicsDeviceHelpInstruction.prototype.ssmlVersion = undefined;
