...
export class BaggageData {
  /**
   * Constructs a new <code>BaggageData</code>.
   ...
   * @alias module:model/BaggageData
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new BaggageData();
      if (data.hasOwnProperty('baggageMeasurements'))
        obj.baggageMeasurements = BaggageDataBaggageMeasurements.constructFromObject(data['baggageMeasurements']);
      if (data.hasOwnProperty('barcodeTagList'))
        obj.barcodeTagList = BaggageDataBarcodeTagList.constructFromObject(data['barcodeTagList']);
      if (data.hasOwnProperty('rfidTagList'))
        obj.rfidTagList = BaggageDataRfidTagList.constructFromObject(data['rfidTagList']);
 ...
 */
BaggageData.prototype.baggageMeasurements = undefined;

/**
 * @member {module:model/BaggageDataBarcodeTagList} barcodeTagList
 */
BaggageData.prototype.barcodeTagList = undefined;

/**
 * @member {module:model/BaggageDataRfidTagList} rfidTagList
 */
BaggageData.prototype.rfidTagList = undefined;
