...
export class BiometricProviderMessageBiometricRequestData {
  /**
   * Constructs a new <code>BiometricProviderMessageBiometricRequestData</code>.
   ...
   * @alias module:model/BiometricProviderMessageBiometricRequestData
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new BiometricProviderMessageBiometricRequestData();
      if (data.hasOwnProperty('processing'))
        obj.processing = BiometricProviderMessageBiometricRequestDataProcessing.constructFromObject(data['processing']);
 ...
 */
BiometricProviderMessageBiometricRequestData.prototype.processing = undefined;

/**
 * @member {module:model/PassengerDataType} passenger
 */
BiometricProviderMessageBiometricRequestData.prototype.passenger = undefined;
