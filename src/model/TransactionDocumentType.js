...
const TransactionDocumentType = {
  ...
  /**
   * Returns a <code>TransactionDocumentType</code> enum value from a JavaScript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
  * @return {module:model/TransactionDocumentType} The enum <code>TransactionDocumentType</code> value.
   */
...
export {TransactionDocumentType};