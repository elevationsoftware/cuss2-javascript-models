...
export class EnvironmentComponent {
  /**
   * Constructs a new <code>EnvironmentComponent</code>.
   * @alias module:model/EnvironmentComponent
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new EnvironmentComponent();
      ...
      if (data.hasOwnProperty('componentType'))
        obj.componentType = ComponentTypes.constructFromObject(data['componentType']);
      if (data.hasOwnProperty('componentCharacteristics'))
        obj.componentCharacteristics = ApiClient.convertToType(data['componentCharacteristics'], [ComponentCharacteristics]);
      if (data.hasOwnProperty('linkedComponentIDs'))
        obj.linkedComponentIDs = ApiClient.convertToType(data['linkedComponentIDs'], [ComponentID]);
    }
    return obj;
  }
}
 ...
 */
EnvironmentComponent.prototype.componentDescription = undefined;

/**
 * @member {module:model/ComponentID} componentID
 */
EnvironmentComponent.prototype.componentID = undefined;

/**
 * @member {module:model/ComponentTypes} componentType
 */
EnvironmentComponent.prototype.componentType = undefined;
 ...
 */
EnvironmentComponent.prototype.componentCharacteristics = undefined;

/**
 * A list of identifiers of components linked to this component.
 * @member {Array.<module:model/ComponentID>} linkedComponentIDs
 */
EnvironmentComponent.prototype.linkedComponentIDs = undefined;
