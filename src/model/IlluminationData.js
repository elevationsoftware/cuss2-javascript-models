...
import {BlinkingRateType} from './BlinkingRateType.js';
import {IlluminationDataLightColor} from './IlluminationDataLightColor.js';
...
export class IlluminationData {
   ...
   */
  constructor(duration, lightColor) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new IlluminationData();
      if (data.hasOwnProperty('duration'))
        obj.duration = ApiClient.convertToType(data['duration'], 'Number');
      if (data.hasOwnProperty('lightColor'))
        obj.lightColor = IlluminationDataLightColor.constructFromObject(data['lightColor']);
      if (data.hasOwnProperty('blinkRate'))
        obj.blinkRate = BlinkingRateType.constructFromObject(data['blinkRate']);
    }
    return obj;
  }
}
 ...
 */
IlluminationData.prototype.duration = undefined;

/**
 * @member {module:model/IlluminationDataLightColor} lightColor
 */
IlluminationData.prototype.lightColor = undefined;

/**
 * @member {module:model/BlinkingRateType} blinkRate
 */
IlluminationData.prototype.blinkRate = undefined;
