...
const EventModes = {
  ...
  /**
   * Returns a <code>EventModes</code> enum value from a JavaScript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
  * @return {module:model/EventModes} The enum <code>EventModes</code> value.
   */
