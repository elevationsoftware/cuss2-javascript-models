...
export class EPaymentMessageTransactionTransactionRequestAccount {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new EPaymentMessageTransactionTransactionRequestAccount();
      if (data.hasOwnProperty('accountType'))
        obj.accountType = ApiClient.convertToType(data['accountType'], 'String');
      if (data.hasOwnProperty('manual'))
        obj.manual = EPaymentMessageTransactionTransactionRequestAccountManual.constructFromObject(data['manual']);
      if (data.hasOwnProperty('swipe'))
        obj.swipe = EPaymentMessageTransactionTransactionRequestAccountSwipe.constructFromObject(data['swipe']);
    }
    return obj;
  }
}
 ...
 * @readonly
 */
EPaymentMessageTransactionTransactionRequestAccount.AccountTypeEnum = {
  /**
   * value: "MANUAL"
   * @const
   */
...
/**
 * @member {module:model/EPaymentMessageTransactionTransactionRequestAccount.AccountTypeEnum} accountType
 */
EPaymentMessageTransactionTransactionRequestAccount.prototype.accountType = undefined;

/**
 * @member {module:model/EPaymentMessageTransactionTransactionRequestAccountManual} manual
 */
EPaymentMessageTransactionTransactionRequestAccount.prototype.manual = undefined;

/**
 * @member {module:model/EPaymentMessageTransactionTransactionRequestAccountSwipe} swipe
 */
EPaymentMessageTransactionTransactionRequestAccount.prototype.swipe = undefined;
