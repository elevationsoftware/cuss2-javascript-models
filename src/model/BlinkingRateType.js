...
export class BlinkingRateType {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new BlinkingRateType();
      if (data.hasOwnProperty('durationOff'))
        obj.durationOff = ApiClient.convertToType(data['durationOff'], 'Number');
      if (data.hasOwnProperty('durationOn'))
        obj.durationOn = ApiClient.convertToType(data['durationOn'], 'Number');
    }
    return obj;
  }
}
 ...
 * @member {Number} durationOn
 */
BlinkingRateType.prototype.durationOn = undefined;
