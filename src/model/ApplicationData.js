  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('meta'))
        obj.meta = ApplicationDataMeta.constructFromObject(data['meta']);
      if (data.hasOwnProperty('payload'))
        obj.payload = ApplicationDataPayload.constructFromObject(data['payload']);
    }
    return obj;
  }
}
...
/**
 * @member {module:model/ApplicationDataMeta} meta
 */
ApplicationData.prototype.meta = undefined;

/**
 * @member {module:model/ApplicationDataPayload} payload
 */
ApplicationData.prototype.payload = undefined;
