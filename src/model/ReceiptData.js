...
/**
 * The ReceiptData model module.
 * @module model/ReceiptData
 * @version 1.0.0
 */
export class ReceiptData {
  /**
   * Constructs a new <code>ReceiptData</code>.
   * Acquirer-provided pre-formatted receipt data. This element provides pre-formatted receipt data that is the application’s responsibility to print. The data format is in raw text including line feeds and may be encoded as a CDATA element.  It is an application business logic decision, and potentially a bank certification requirement, to properly format and print this data on a document for the customer. For an approval, key data elements used on the receipt are also provided separately under the approval response.
   * @alias module:model/ReceiptData
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>ReceiptData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ReceiptData} obj Optional instance to populate.
   * @return {module:model/ReceiptData} The populated <code>ReceiptData</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ReceiptData();
    }
    return obj;
  }
}
