...
export class AuthorizationAmounts {
  /**
   * Constructs a new <code>AuthorizationAmounts</code>.
   * Requested or authorized financial elements.
   * @alias module:model/AuthorizationAmounts
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AuthorizationAmounts();
      if (data.hasOwnProperty('requestedAmounts'))
        obj.requestedAmounts = AmountType.constructFromObject(data['requestedAmounts']);
      if (data.hasOwnProperty('approvedAmounts'))
        obj.approvedAmounts = AmountType.constructFromObject(data['approvedAmounts']);
    }
    return obj;
  }
}
 ...
 */
AuthorizationAmounts.prototype.requestedAmounts = undefined;

/**
 * @member {module:model/AmountType} approvedAmounts
 */
AuthorizationAmounts.prototype.approvedAmounts = undefined;
