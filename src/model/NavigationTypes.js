...
const NavigationTypes = {
  /**
   * value: "NON_APPLICABLE_NAVIGATION_TYPE"
   * @const
   */
  ...
  /**
   * value: "AUDIONAV_6_KEY"
   * @const
   */
  aUDIONAV6KEY: "AUDIONAV_6_KEY",

  /**
   * value: "AUDIONAV_6_KEY_BAR"
   * @const
   */
  aUDIONAV6KEYBAR: "AUDIONAV_6_KEY_BAR",

  /**
   * Returns a <code>NavigationTypes</code> enum value from a JavaScript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
  * @return {module:model/NavigationTypes} The enum <code>NavigationTypes</code> value.
   */
