...
export class CommonUsePaymentMessageErrorResponse {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CommonUsePaymentMessageErrorResponse();
      if (data.hasOwnProperty('errorDocument'))
        obj.errorDocument = ApiClient.convertToType(data['errorDocument'], 'Blob');
 ...
 */
CommonUsePaymentMessageErrorResponse.prototype.errorDocument = undefined;

/**
 * Allowed values for the <code>errorReason</code> property.
 * @enum {String}
 * @readonly
 */
 ...
 * @member {module:model/CommonUsePaymentMessageErrorResponse.ErrorReasonEnum} errorReason
 */
CommonUsePaymentMessageErrorResponse.prototype.errorReason = undefined;

/**
 * Error code as reported from the system(s) down the line.
 * @member {Number} errorCode
 */
CommonUsePaymentMessageErrorResponse.prototype.errorCode = undefined;
