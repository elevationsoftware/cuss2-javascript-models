...
/**
 * Enum class BiometricProviderMessageType.
 * @enum {String}
 * @readonly
 */
const BiometricProviderMessageType = {
  /**
   * value: "NONE"
   * @const
   */
  ...
  /**
   * Returns a <code>BiometricProviderMessageType</code> enum value from a JavaScript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
  * @return {module:model/BiometricProviderMessageType} The enum <code>BiometricProviderMessageType</code> value.
   */
...
export {BiometricProviderMessageType};