...
export class ScreenResolution {
  /**
   * Constructs a new <code>ScreenResolution</code>.
   * A single x-y screen resolution measured in pixel.
   * @alias module:model/ScreenResolution
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ScreenResolution();
      if (data.hasOwnProperty('vertical'))
        obj.vertical = ApiClient.convertToType(data['vertical'], 'Number');
 ...
 */
ScreenResolution.prototype.vertical = undefined;

/**
 * @member {Number} horizontal
 */
ScreenResolution.prototype.horizontal = undefined;
