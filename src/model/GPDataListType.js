...
export class GPDataListType {
   ...
   */
  constructor(gpDataItems) {
    this.gpDataItems = gpDataItems;
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new GPDataListType();
      if (data.hasOwnProperty('gpDataItems'))
        obj.gpDataItems = ApiClient.convertToType(data['gpDataItems'], [GPDataItemType]);
    }
    return obj;
  }
}
 ...
 * @member {Array.<module:model/GPDataItemType>} gpDataItems
 */
GPDataListType.prototype.gpDataItems = undefined;
