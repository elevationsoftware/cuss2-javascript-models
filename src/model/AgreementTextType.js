...
export class AgreementTextType {
   ...
   */
  constructor(acceptanceMandatory) {
    this.acceptanceMandatory = acceptanceMandatory;
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AgreementTextType();
      if (data.hasOwnProperty('agreementText'))
        obj.agreementText = ApiClient.convertToType(data['agreementText'], 'String');
      if (data.hasOwnProperty('acceptanceMandatory'))
        obj.acceptanceMandatory = ApiClient.convertToType(data['acceptanceMandatory'], 'Boolean');
      if (data.hasOwnProperty('agreementName'))
        obj.agreementName = ApiClient.convertToType(data['agreementName'], 'String');
    }
    return obj;
  }
}
 ...
 */
AgreementTextType.prototype.agreementText = undefined;

/**
 * @member {Boolean} acceptanceMandatory
 */
AgreementTextType.prototype.acceptanceMandatory = undefined;

/**
 * @member {String} agreementName
 */
AgreementTextType.prototype.agreementName = undefined;
