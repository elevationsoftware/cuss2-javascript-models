...
export class PassengerDataTypePassengerMRZData {
   ...
   */
  constructor(mrzTrackData) {
    this.mrzTrackData = mrzTrackData;
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new PassengerDataTypePassengerMRZData();
      if (data.hasOwnProperty('mrzTrackData'))
        obj.mrzTrackData = ApiClient.convertToType(data['mrzTrackData'], [MRZTrackType]);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:model/MRZTrackType>} mrzTrackData
 */
PassengerDataTypePassengerMRZData.prototype.mrzTrackData = undefined;
