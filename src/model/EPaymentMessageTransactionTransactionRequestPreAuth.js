...
export class EPaymentMessageTransactionTransactionRequestPreAuth {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new EPaymentMessageTransactionTransactionRequestPreAuth();
      ...
      if (data.hasOwnProperty('approvalAmounts'))
        obj.approvalAmounts = AmountType.constructFromObject(data['approvalAmounts']);
    }
    return obj;
  }
}
 ...
 */
EPaymentMessageTransactionTransactionRequestPreAuth.prototype.transactionReference = undefined;

/**
 * @member {module:model/ApprovalCode} approvalCode
 */
EPaymentMessageTransactionTransactionRequestPreAuth.prototype.approvalCode = undefined;

/**
 * @member {module:model/AmountType} approvalAmounts
 */
EPaymentMessageTransactionTransactionRequestPreAuth.prototype.approvalAmounts = undefined;
