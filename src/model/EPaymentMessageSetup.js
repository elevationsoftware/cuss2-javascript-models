...
export class EPaymentMessageSetup {
  /**
   * Constructs a new <code>EPaymentMessageSetup</code>.
   * Execution context setup.
   * @alias module:model/EPaymentMessageSetup
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new EPaymentMessageSetup();
      if (data.hasOwnProperty('dsTypes'))
        obj.dsTypes = DsTypesEpayment.constructFromObject(data['dsTypes']);
 ...
 */
EPaymentMessageSetup.prototype.dsTypes = undefined;

/**
 * @member {module:model/MerchantID} merchantID
 */
EPaymentMessageSetup.prototype.merchantID = undefined;

/**
 * @member {module:model/FeatureList} featureList
 */
EPaymentMessageSetup.prototype.featureList = undefined;

/**
 * @member {module:model/CardBrandList} cardBrandList
 */
EPaymentMessageSetup.prototype.cardBrandList = undefined;

/**
 * @member {module:model/MediaTypeList} mediaTypeList
 */
EPaymentMessageSetup.prototype.mediaTypeList = undefined;

/**
 * @member {module:model/CurrencyCodeList} currencyCodeList
 */
EPaymentMessageSetup.prototype.currencyCodeList = undefined;
