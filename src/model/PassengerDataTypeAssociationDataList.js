...
export class PassengerDataTypeAssociationDataList {
  /**
   * Constructs a new <code>PassengerDataTypeAssociationDataList</code>.
   * Passenger attribute association data managed by the client.
   * @alias module:model/PassengerDataTypeAssociationDataList
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new PassengerDataTypeAssociationDataList();
      if (data.hasOwnProperty('associationDataItem'))
        obj.associationDataItem = ApiClient.convertToType(data['associationDataItem'], [AssociationDataItemType]);
    }
    return obj;
  }
}
 ...
 */
PassengerDataTypeAssociationDataList.prototype.associationDataItem = undefined;
