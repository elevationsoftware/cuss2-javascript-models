...
/**
 * Enum class ApplicationStateChangeReasonCodes.
 * @enum {String}
 * @readonly
 */
const ApplicationStateChangeReasonCodes = {
  /**
  ...
  /**
   * value: "OUT_OF_SERVICE_HOURS"
   * @const
   */
  OUT_OF_SERVICE_HOURS: "OUT_OF_SERVICE_HOURS",

  /**
   * value: "OUT_OF_SERVICE_HARDWARE"
   * @const
   */
  OUT_OF_SERVICE_HARDWARE: "OUT_OF_SERVICE_HARDWARE",

  /**
   * value: "OUT_OF_SERVICE_BHS"
   * @const
   */
  OUT_OF_SERVICE_BHS: "OUT_OF_SERVICE_BHS",

  /**
   * value: "OUT_OF_SERVICE_CONSUMABLES"
   * @const
   */
  OUT_OF_SERVICE_CONSUMABLES: "OUT_OF_SERVICE_CONSUMABLES",

  /**
   * value: "OUT_OF_SERVICE_INTERNAL"
   * @const
   */
  OUT_OF_SERVICE_INTERNAL: "OUT_OF_SERVICE_INTERNAL",

  /**
   * value: "OUT_OF_SERVICE_DCS"
   * @const
   */
  OUT_OF_SERVICE_DCS: "OUT_OF_SERVICE_DCS",

  /**
   * value: "OUT_OF_SERVICE_BACKEND"
   * @const
   */
  OUT_OF_SERVICE_BACKEND: "OUT_OF_SERVICE_BACKEND",

  /**
   * Returns a <code>ApplicationStateChangeReasonCodes</code> enum value from a JavaScript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
  * @return {module:model/ApplicationStateChangeReasonCodes} The enum <code>ApplicationStateChangeReasonCodes</code> value.
   */
