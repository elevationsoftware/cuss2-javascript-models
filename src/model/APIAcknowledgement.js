...
export class APIAcknowledgement {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new APIAcknowledgement();
      if (data.hasOwnProperty('ackCode'))
        obj.ackCode = AckCodes.constructFromObject(data['ackCode']);
...
/**
 * @member {module:model/AckCodes} ackCode
 */
APIAcknowledgement.prototype.ackCode = undefined;

/**
 * @member {module:model/RequestID} requestID
 */
APIAcknowledgement.prototype.requestID = undefined;

/**
 * Optional description of the returned error (if any)
 * @member {String} description
 */
APIAcknowledgement.prototype.description = undefined;
