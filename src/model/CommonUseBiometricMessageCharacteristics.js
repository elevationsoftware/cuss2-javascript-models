...
export class CommonUseBiometricMessageCharacteristics {
   ...
   */
  constructor(characteristicsDocumentType, characteristicsDocumentReturnType) {
    this.characteristicsDocumentType = characteristicsDocumentType;
    this.characteristicsDocumentReturnType = characteristicsDocumentReturnType;
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CommonUseBiometricMessageCharacteristics();
      if (data.hasOwnProperty('characteristicsDocumentType'))
        obj.characteristicsDocumentType = CharacteristicsDocumentType.constructFromObject(data['characteristicsDocumentType']);
      if (data.hasOwnProperty('characteristicsDocumentReturnType'))
        obj.characteristicsDocumentReturnType = CharacteristicsDocumentType.constructFromObject(data['characteristicsDocumentReturnType']);
      if (data.hasOwnProperty('characteristicsRequest'))
        obj.characteristicsRequest = BiometricAnyType.constructFromObject(data['characteristicsRequest']);
      if (data.hasOwnProperty('characteristicsResponse'))
        obj.characteristicsResponse = CommonUseBiometricMessageCharacteristicsCharacteristicsResponse.constructFromObject(data['characteristicsResponse']);
    }
    return obj;
  }
}
...
/**
 * @member {module:model/CharacteristicsDocumentType} characteristicsDocumentType
 */
CommonUseBiometricMessageCharacteristics.prototype.characteristicsDocumentType = undefined;

/**
 * @member {module:model/CharacteristicsDocumentType} characteristicsDocumentReturnType
 */
CommonUseBiometricMessageCharacteristics.prototype.characteristicsDocumentReturnType = undefined;

/**
 * @member {module:model/BiometricAnyType} characteristicsRequest
 */
CommonUseBiometricMessageCharacteristics.prototype.characteristicsRequest = undefined;

/**
 * @member {module:model/CommonUseBiometricMessageCharacteristicsCharacteristicsResponse} characteristicsResponse
 */
CommonUseBiometricMessageCharacteristics.prototype.characteristicsResponse = undefined;
