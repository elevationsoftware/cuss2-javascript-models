...
export class EPaymentMessageTransactionTransactionRequestAccountManual {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new EPaymentMessageTransactionTransactionRequestAccountManual();
 ...
 * @member {String} pan
 */
EPaymentMessageTransactionTransactionRequestAccountManual.prototype.pan = undefined;

/**
 * MMYY format.
 * @member {String} expiration
 */
EPaymentMessageTransactionTransactionRequestAccountManual.prototype.expiration = undefined;
