...
/**
 * Enum class ApplicationStateCodes.
 * @enum {String}
 * @readonly
 */
const ApplicationStateCodes = {
  /**
   * value: "INITIALIZE"
   * @const
   */
  ...
  /**
   * Returns a <code>ApplicationStateCodes</code> enum value from a JavaScript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
  * @return {module:model/ApplicationStateCodes} The enum <code>ApplicationStateCodes</code> value.
   */
