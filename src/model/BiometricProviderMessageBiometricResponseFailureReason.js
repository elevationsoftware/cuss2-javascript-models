...
export class BiometricProviderMessageBiometricResponseFailureReason {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new BiometricProviderMessageBiometricResponseFailureReason();
...
/**
 * Allowed values for the <code>failureCode</code> property.
 * @enum {String}
 * @readonly
 */
BiometricProviderMessageBiometricResponseFailureReason.FailureCodeEnum = {
  ...
  /**
   * value: "POOR_CAMERA_IMAGE"
   * @const
   */
  POOR_CAMERA_IMAGE: "POOR_CAMERA_IMAGE",

  /**
   * value: "POOR_DOCUMENT_IMAGE"
   * @const
   */
  POOR_DOCUMENT_IMAGE: "POOR_DOCUMENT_IMAGE",
 ...
 * @member {module:model/BiometricProviderMessageBiometricResponseFailureReason.FailureCodeEnum} failureCode
 */
BiometricProviderMessageBiometricResponseFailureReason.prototype.failureCode = undefined;

/**
 * Optional free form text describing the failure.
 * @member {String} failureDescription
 */
BiometricProviderMessageBiometricResponseFailureReason.prototype.failureDescription = undefined;
