...
export class EPaymentMessageTransactionTransactionRequestItinerary {
  /**
   * Constructs a new <code>EPaymentMessageTransactionTransactionRequestItinerary</code>.
   ...
   * @alias module:model/EPaymentMessageTransactionTransactionRequestItinerary
   * @class
   */
  constructor() {
  }
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new EPaymentMessageTransactionTransactionRequestItinerary();
      if (data.hasOwnProperty('name'))
        obj.name = ApiClient.convertToType(data['name'], 'String');
      if (data.hasOwnProperty('pnr'))
        obj.pnr = ApiClient.convertToType(data['pnr'], 'String');
      if (data.hasOwnProperty('date'))
        obj._date = ApiClient.convertToType(data['date'], 'Date');
      if (data.hasOwnProperty('flight-number'))
        obj.flightNumber = ApiClient.convertToType(data['flight-number'], 'String');
      if (data.hasOwnProperty('departure-city'))
        obj.departureCity = ApiClient.convertToType(data['departure-city'], 'String');
      if (data.hasOwnProperty('arrival-city'))
        obj.arrivalCity = ApiClient.convertToType(data['arrival-city'], 'String');
    }
    return obj;
  }
}
 ...
 * @member {String} name
 */
EPaymentMessageTransactionTransactionRequestItinerary.prototype.name = undefined;

/**
 * Passenger name record.
 * @member {String} pnr
 */
EPaymentMessageTransactionTransactionRequestItinerary.prototype.pnr = undefined;

/**
 * Transaction (flight) date (e.g. 2018-11-13).
 * @member {Date} _date
 */
EPaymentMessageTransactionTransactionRequestItinerary.prototype._date = undefined;

/**
 * Airline identifier and flight number.
 * @member {String} flightNumber
 */
EPaymentMessageTransactionTransactionRequestItinerary.prototype.flightNumber = undefined;

/**
 * Departure city code.
 * @member {String} departureCity
 */
EPaymentMessageTransactionTransactionRequestItinerary.prototype.departureCity = undefined;

/**
 * Arrival city code.
 * @member {String} arrivalCity
 */
EPaymentMessageTransactionTransactionRequestItinerary.prototype.arrivalCity = undefined;
