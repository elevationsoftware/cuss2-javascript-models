...
export class BiometricProviderMessageBiometricRequestEnvironment {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new BiometricProviderMessageBiometricRequestEnvironment();
      if (data.hasOwnProperty('accessibilityMode'))
        obj.accessibilityMode = ApiClient.convertToType(data['accessibilityMode'], 'Boolean');
 ...
 */
BiometricProviderMessageBiometricRequestEnvironment.prototype.accessibilityMode = undefined;

/**
 * ISO 639-1 (2-character) code for the interface language to be used by the biometric provider.
 * @member {String} language
 */
BiometricProviderMessageBiometricRequestEnvironment.prototype.language = undefined;
