...
export class ApplicationActivation {
   ...
   */
  constructor(executionMode, accessibleMode, languageID) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ApplicationActivation();
      ...
      if (data.hasOwnProperty('executionOptions'))
        obj.executionOptions = ApiClient.convertToType(data['executionOptions'], ['String']);
 ...
 */
ApplicationActivation.prototype.applicationBrand = undefined;
